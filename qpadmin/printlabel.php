...
//
//This file prints a herbarium label from information passed from the HTML form located in labels.php via the $_GET form.
//
//the include files:
...
$query = "SELECT * FROM iknew
              WHERE Accession LIKE '$searchaccession'
              LIMIT 50";
...
echo "<tr><td><br></td></tr>";
echo "<tr><td><b>$row[Family]<b></td></tr>";
echo "<tr><td><br></td></tr>";
echo "<tr><td>$row[Taxon]</td></tr>";
echo "<tr><td><br></td></tr>";
echo "<tr><td>Locality: $row[Locality]<br></td></tr>";
echo "<tr><td>Latitude: $row[Latitude]  Longitude: $row[Longitude]</td></tr>";
echo "<tr><td><br></td></tr>";
echo "<tr><td>Habitat: $row[Habitat]<br></td></tr>";
echo "<tr><td><br></td></tr>";
