...
//
//This file generates a table called duplicates and populates it with duplicates by accession from the IKnew table.  It also
//displays the results of the duplicate search.
//
//the include files:
